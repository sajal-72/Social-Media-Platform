    ...
    <WidgetWrapper>
      ...
      <Box p="1rem 0">
        ...
        <Box display="flex" alignItems="center" gap="1rem">
          <WorkOutlineOutlined fontSize="large" sx={{ color: dark }} />
      ...
      <Box p="1rem 0">
        <FlexBetween mb="0.5rem">
          <Typography color={dark}>Who's viewed your profile</Typography>
          <Typography color={dark} fontWeight="500">
            {viewedProfile}
          </Typography>
        </FlexBetween>
        <FlexBetween>
          <Typography color={dark}>Impressions of your post</Typography>
          <Typography color={dark} fontWeight="500">
            {impressions}
          </Typography>
        </FlexBetween>
        ...
        <FlexBetween gap="1rem" mb="0.5rem">
          <FlexBetween gap="1rem">
            ...
            <Box>
              ...
              <Typography color={dark}>Social Network</Typography>
            </Box>
          </FlexBetween>
        ...
        <FlexBetween gap="1rem">
          <FlexBetween gap="1rem">
            ...
            <Box>
              ...
              <Typography color={dark}>Network Platform</Typography>
            </Box>
          </FlexBetween>
          <EditOutlined sx={{ color: dark }} />
        </FlexBetween>
